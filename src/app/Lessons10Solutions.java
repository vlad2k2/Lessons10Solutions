...
public class Lessons10Solutions {
    ...
    public static void main(String[] args) {
        ...
        double cylinder = calculateCylinder(radius, height);
        ...
        System.out.println("Сума елементів масиву = " + arrSum(array));
        printLn();
        ...
        String revers = reversString(string);
        ...
        printTextNTimes(countLine, textLn);
    }
}
